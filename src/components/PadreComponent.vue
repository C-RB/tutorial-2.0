<template>
    <div class="container">
        ...
        <HijoComponent :mensaje="mensajePadre" @actualizarMensaje="mensajePadre =
            $event" />
...
export default {
    components: {
        HijoComponent // Importación del componente hijo
    },
    data() {
        return {
    ...
    methods: {
        resetearMensaje() {
            this.mensajePadre = 'Hola desde el padre'; // Método para resetearel mensaje del padre
        }
    }
}
</script>